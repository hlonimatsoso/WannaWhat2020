...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class ExternalController : Controller
    {
        ...
        private async Task<(WannaWhatUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
        ...
        private async Task<WannaWhatUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
